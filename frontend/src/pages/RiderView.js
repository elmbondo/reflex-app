    ...
    <div className="rider-portal-page">
      <div className="rider-portal-container">
        <div style={{ marginBottom: '14px' }}>
          <Link to="/" className="rider-back-link" style={{ textDecoration: 'none', color: 'var(--color-terracotta, #c85a32)', fontWeight: 600, fontSize: '0.9rem', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
