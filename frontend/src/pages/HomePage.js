      ...
      <header className="home-nav">
        ...
        {mobileMenuOpen && (
          <nav className="mobile-drawer" aria-label="Mobile navigation">
            ...
            <Link to="/retailer" className="mobile-nav-link mobile-nav-cta" onClick={closeMobileMenu}>Send a Delivery ΓåÆ</Link>
          </nav>
        )}
      </header>

      {/* Hero Section ΓÇö Photographic backdrop with subtle overlay */}
        ...
        <div className="callout-card retailer-callout">
          <div className="callout-content">
            ...
            <p className="callout-desc">
              Start dispatching customer parcels today. No complex contracts, no tedious onboarding ΓÇö open your retailer portal and submit your first delivery request right away.
            </p>
