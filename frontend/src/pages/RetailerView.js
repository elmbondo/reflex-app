...
// Functional delivery-request experience: allows Kenyan merchants to quickly log
// customer package details, validates inputs, submits to real POST /api/deliveries,
// and displays live status and recent requests.
...
function RetailerView() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage =
        ...
        'Unable to submit delivery request. Please check your connection and try again.';
  ...
  return (
    <div className="retailer-page">
      {/* Top Navbar */}
      <nav className="retailer-top-nav">
        <div className="retailer-nav-inner">
          ...
          <div className="retailer-nav-actions">
      ...
      <main className="retailer-container" aria-label="Retailer Delivery Management">
        ...
        <header className="retailer-hero-banner">
          <div className="retailer-badge-pill">
            <span className="badge-dot" aria-hidden="true"></span>
            Retailer Delivery Portal
          </div>
          <h1 className="retailer-headline">Create & Track Customer Deliveries</h1>
          <p className="retailer-lead">
            Log your customer's package details below for instant rider assignment and live status visibility across town.
          </p>
        </header>
        ...
        <div className="retailer-layout">
          ...
          <section className="retailer-card primary-card" aria-labelledby="form-heading">
              ...
              <div className="card-title-group">
                ...
                <div>
                  ...
                  <p className="card-caption">
                    {submitSuccessData ? 'Order captured and queued for rider dispatch' : 'Enter recipient details and package contents'}
                  </p>
                </div>
              </div>
            </div>
            ...
            {submitSuccessData ? (
              <div className="success-card" role="region" aria-live="polite">
                ...
                <div className="success-details-box">
                  ...
                  <div className="detail-row">
                    <span className="detail-label">Package Items</span>
                ...
                >
                  ...
                  <span>Log Another Delivery</span>
                </button>
              </div>
            ) : (
              /* Creation Form */
              <form className="delivery-form" onSubmit={handleSubmit} noValidate>
                ...
                <div className="form-group">
                  ...
                  <div id="phone-helper" className="field-helper">Rider will call this number upon doorstep arrival</div>
                ...
                <div className="form-group">
                  ...
                  <div className="input-wrapper">
                    ...
                    <input
                      ...
                      placeholder="e.g. Biashara Plaza 3rd Flr, Room 14, CBD Nairobi"
                      value={form.address}
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="itemDescription">
                    Item / Package Description <span className="required-star">*</span>
                  </label>
                  <div className="input-wrapper">
                    <span className="input-icon" aria-hidden="true" style={{ top: '14px' }}>
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <section className="retailer-card" aria-labelledby="queue-heading">
            <div className="card-header">
              <div className="card-title-group">
                <div className="card-icon icon-sand" aria-hidden="true">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div>
                  <h2 id="queue-heading" className="card-title">Recent Requests</h2>
                  <p className="card-caption">Live status of your logged customer parcels</p>
                </div>
              </div>
              <div className="queue-header-actions">
                ...
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ transform: isLoadingDeliveries ? 'rotate(180deg)' : 'none', transition: 'transform 0.5s ease' }} aria-hidden="true">
            ...
            <div className="retailer-stats">
              ...
              <div className="stat-box">
                <div className="stat-number stat-amber">{pendingCount}</div>
                <div className="stat-label">Pending</div>
              </div>
              <div className="stat-box">
                <div className="stat-number stat-green">{completedCount}</div>
                  ...
                  <li key={d._id || `${d.customerName}-${d.createdAt || Math.random()}`} className="request-item">
                    <div className="request-top">
                      <div className="customer-name">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--color-terracotta)' }} aria-hidden="true">
                          <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                          <circle cx="12" cy="7" r="4"></circle>
                        </svg>
